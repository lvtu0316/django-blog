...
class PostModelTestCase(TestCase):
    def setUp(self):
        ...
        category = Category.objects.create(name='测试')
    ...
    def test_auto_populate_modified_time(self):
        ...
        old_post_modified_time = self.post.update_at
        self.post.body = '新的测试内容'
        self.post.save()
        self.post.refresh_from_db()
        self.assertTrue(self.post.update_at > old_post_modified_time)
    ...
    def test_get_absolute_url(self):
        expected_url = reverse('blog:post.show', kwargs={'pk': self.post.pk})
